...
from games.autoqfm import MuZeroConfig
from games.autoqfm import Game
...
class MuZero:
    ...
    Example:
        ...
        >>> muzero.train()
        >>> muzero.test(render=False) -> for AutoQFM RL
    """
    ...
    def test(
        self, render=False, opponent=None, muzero_player=None, num_tests=1, num_gpus=0
    ):
        """
